        ...
        <ScrollView contentContainerStyle={styles.scrollViewContainer}>
            <View style={styles.container}>
                ...
                <Text style={styles.content}>
                    • Mô tả chi tiết về dịch vụ được cung cấp, bao gồm các tính năng, sản phẩm hoặc dịch vụ cụ thể được
                    cung cấp.
                ...
                <Text style={styles.content}>
                    • Xác định thời gian và địa điểm cụ thể của dịch vụ, bao gồm cả thời gian dự kiến cho mỗi phần của
                    dịch vụ (nếu có).
                </Text>

                <Text style={styles.sectionTitle}>3. Phí và Thanh toán</Text>
                <Text style={styles.content}>
                    • Mô tả chi tiết về cách tính phí dịch vụ và bất kỳ chi phí phát sinh nào khác, cũng như thời gian
                ...
                <Text style={styles.content}>
                    • Quy định về chính sách hủy bỏ và điều kiện để nhận hoàn tiền, bao gồm cả thời gian cần thông báo
                    trước để hủy bỏ và mức độ hoàn tiền (nếu có).
                    {'\n'}• Các quy định cụ thể về việc hủy bỏ và điều kiện áp dụng.
                </Text>

                <Text style={styles.sectionTitle}>5. Trách nhiệm và Bảo hiểm</Text>
                <Text style={styles.content}>
                    • Xác định trách nhiệm của mỗi bên trong trường hợp có thiệt hại hoặc mất mát, cũng như yêu cầu về
                    bảo hiểm (nếu cần).
                ...
                <Text style={styles.content}>
                    • Xác định quyền sở hữu của dữ liệu và tài sản liên quan đến dịch vụ, cũng như cách thức sử dụng
                    chúng.
                ...
                <Text style={styles.content}>
                    • Quy định về việc chấp thuận và xác nhận các điều khoản và điều kiện của dịch vụ, bao gồm cách thức
                ...
                <Text style={styles.content}>
                    • Quy định cách giải quyết tranh chấp, bao gồm việc sử dụng trọng tài, pháp luật hoặc các phương
                    thức khác.
                ...
                <Text style={styles.content}>
                    • Quy định về việc thay đổi hoặc sửa đổi các điều khoản và điều kiện của dịch vụ và cách thức thực
                    hiện điều này.
                    {'\n'}• Quy trình thông báo và áp dụng các thay đổi cho các bên liên quan, cũng như cách thức thực
                    hiện việc thông báo và hiệu lực của các sửa đổi.
                </Text>
                ...
                <Text style={styles.content}>
                    ...
                    {'\n'}• Thông tin về việc áp dụng luật pháp và quyền lợi của các bên trong quá trình giải quyết
                    tranh chấp.
                </Text>
            </View>
        </ScrollView>
